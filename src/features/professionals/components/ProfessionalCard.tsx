        ...
        <View style={styles.row}>
          ...
          <View style={styles.info}>
            ...
            <View style={styles.metaRow}>
              <View style={[styles.badge, professional.isOnline ? styles.onlineBadge : styles.offlineBadge]}>
                <Text style={[styles.badgeText, professional.isOnline ? styles.onlineText : styles.offlineText]}>
                  {professional.isOnline ? "Disponible" : "No disponible"}
                </Text>
              </View>
              {professional.rating ? <Text style={styles.rating}>★ {professional.rating.toFixed(1)}</Text> : null}
            </View>
          </View>
