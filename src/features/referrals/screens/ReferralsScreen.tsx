...
export default function ReferralsScreen() {
  ...
  async function handleShare() {
    await Share.share({
      message: `Únete a Pachamama Salud con mi código ${code} y empieza tu proceso con profesionales verificados.`,
    });
  }
      ...
      <View style={styles.container}>
        ...
        <AppCard>
          ...
          <Text style={styles.todoHint}>
            TODO: conectar detalle de campañas y trazabilidad de referidos cuando el backend exponga el ledger completo.
          </Text>
        </AppCard>
      </View>
    </AppScreen>
