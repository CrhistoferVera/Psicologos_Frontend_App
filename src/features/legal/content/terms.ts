export const TERMS_LAST_UPDATED = "28 de abril de 2026";
...
export const TERMS_SECTIONS: Array<{ title: string; body: string[] }> = [
  {
    ...
    body: [
      ...
      "La plataforma facilita comunicación, pagos y recargas, sesiones y funcionalidades administrativas asociadas.",
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      "No está permitido usar la plataforma para acoso, amenazas, difusión de contenido ilegal o actividades fraudulentas.",
      "No debes manipular pagos, referidos o saldos mediante prácticas abusivas.",
      "El incumplimiento puede implicar bloqueo de cuenta y acciones legales correspondientes.",
    ],
  },
  {
    ...
    body: [
      ...
      "El saldo se acredita tras la confirmaci�n del pago conforme al m�todo utilizado.",
  ...
  },
  {
    title: "10. Contacto",
    body: [
      "Para consultas sobre estos términos puedes escribir a soporte@sanamente.app.",
    ],
  },
];
