      ...
      <View style={styles.page}>
        ...
        <AppCard style={styles.card}>
          ...
          <View style={styles.summaryRow}>
            ...
            <Text style={styles.summaryValue}>{credits} crd</Text>
          </View>
          <View style={styles.summaryRow}>
            <Text style={styles.summaryLabel}>Total</Text>
            <Text style={styles.summaryValueBold}>${Number(price).toFixed(2)} USD</Text>
          </View>
        </AppCard>
        ...
        {loadingCards ? (
          ...
          <AppCard style={styles.card}>
            ...
            >
              <Text style={styles.payBtnText}>{paying ? "Procesando..." : `Pagar $${Number(price).toFixed(2)}`}</Text>
            </Pressable>
          </AppCard>
        )}
